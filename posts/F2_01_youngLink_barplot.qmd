...
# DE info
HmPtC1 <- readRDS("~/Desktop/ferygood_github/primate_network/data/HmPtC1.rds")
...
g_corr_de <- ggplot(df_combine, aes(log2FoldChange, mean_exp, fill = group)) +
