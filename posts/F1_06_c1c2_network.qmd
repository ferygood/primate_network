...
```{r eval=FALSE}
kznf_age <- read.csv("../tables/kznf_bucket.csv")
...
intersect(pos_kznf_c1$geneName, neg_kznf_c1$geneName) # there are 16 of them have both positive and negative correlation

df_kznf_merge <- rbind(pos_kznf_c1, neg_kznf_c1)
write.csv(df_kznf_merge, file="../tables/c1_Hm_335_linkCount.csv", row.names=FALSE)

df_te_merge <- rbind(pos_te_c1, neg_te_c1)
write.csv(df_te_merge, file="../tables/c1_Hm_335_te_linkCount.csv", row.names=FALSE)
